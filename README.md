...
| Platform | File | Type |
|---|---|---|
| macOS | `TrimBin-1.0.1-arm64-mac.dmg` | Drag-and-drop installer (Apple Silicon) |
| macOS | `TrimBin-1.0.1-arm64-mac.pkg` | Standard package installer (Apple Silicon) |
| macOS | `TrimBin-1.0.1-arm64-mac.zip` | Standalone archive |
| Windows | `TrimBin.Setup.1.0.1.exe` | NSIS installer |
| Windows | `TrimBin.1.0.1.exe` | Portable executable |
| Linux | `TrimBin-1.0.1.AppImage` | Standalone AppImage |
| Linux | `TrimBin-1.0.1.tar.gz` | Compressed archive |
